...
const ContactList = () => {
  ...
  if (!isLoading && isError) {
    content = <h1 className="text-red-500">{t("common:contacts.list.error")}</h1>
  }
    ...
    <div className="w-full mx-auto relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex justify-between items-center gap-3">
          <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">{t("common:contacts.list.title")}</h1>
          <div className="flex items-center">
            <span className="text-sm sm:text-base text-gray-600">{t("common:contacts.list.totalLabel")}</span>
        ...
        <div className="relative w-full sm:w-80">
          ...
          <Input
            placeholder={t("common:contacts.list.searchPlaceholder")}
            value={searchQuery}
